...
<div class="container-fluid">
	...
	<form action="" id="manage-user">
		...
		<div class="form-group">
			<label for="username">BU Email</label>
		...
		<div class="form-group">
			...
			<select name="type" id="type" class="custom-select">
				...
				<option value="3" <?php echo isset($meta['type']) && $meta['type'] == 3 ? 'selected': '' ?>>SubAdmin/DEp.Head</option>
				<option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected': '' ?>>Standard User's/Faculty Member</option>
			</select>
		</div>
	</form>
</div>
